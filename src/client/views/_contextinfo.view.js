    ...
    return (
      <div className="home">
        ...
        <ul>
          <li>
            <b>appIconPosition: </b>
            {this.state.context.appIconPosition}
          </li>
          <li>
            <b>entityId: </b>
            {this.state.context.entityId}
          </li>
          <li>
            <b>hostClientType: </b>
            {this.state.context.hostClientType}
          </li>
          <li>
            <b>locale: </b>
            {this.state.context.locale}
          </li>
          <li>
            <b>loginHint: </b>
          ...
          <li>
            <b>tenantSKU: </b>
            {this.state.context.tenantSKU}
          </li>
          <li>
            <b>jsonTabUrl: </b>
            {this.state.context.jsonTabUrl}
          </li>
          <li>
            <b>theme: </b>
            {this.state.context.theme}
          </li>
          <li>
            <b>tid: </b>
          ...
          <li>
            <b>userLicenseType: </b>
            {this.state.context.userLicenseType}
          </li>
          <li>
            <b>userObjectId: </b>
